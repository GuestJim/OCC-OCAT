...
if ("API" %in% colnames(results)) {
	...
	dataMEAN = aggregate(results$MsBetweenPresents, list(results$GPU, results$Location, results$APIf), meanFPS)
	dataPERC = aggregate(results$MsBetweenPresents, list(results$GPU, results$Location, results$APIf), percFPS)
	dataECDF = aggregate(results$MsBetweenPresents, list(results$GPU, results$Location, results$APIf), ecdfFPS)
