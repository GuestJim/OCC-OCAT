...
ggtitle(paste0(gameQUA, " Frequency Plot"), subtitle="MsBetweenPresents") + 
...
geom_bar(aes(x = Location, y = MsBetweenDisplayChange, fill = GPU), stat = "summary", fun.y = "mean") + 
...
ggtitle(paste0(gameQUA, " Frequency Plot"), subtitle="MsBetweenDisplayChange") + 
geom_vline(xintercept = 1000/60, color = "red") + 
geom_freqpoly(binwidth=0.03, size=0) + 
facet_grid(cols = vars(GPU), rows = vars(Location, API), switch = "y") + 
